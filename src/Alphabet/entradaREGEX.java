...
public class entradaREGEX extends javax.swing.JFrame {
    
    int x, y; 
    Alphabet alphabet;
        
    public entradaREGEX() {
        this.setTitle("Validar identificador");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Palabra inválida");
        mainPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, -1, -1));
        ...
        textAlphabet.setText("Ingresa tu identificador a validar ...");
        ...
        jButton3.setText("Validar identificador");
        ...
        mainPanel.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 210, 180, 60));

        jLabel3.setFont(new java.awt.Font("JetBrains Mono NL", 1, 24)); // NOI18N
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8-codepen-48.png"))); // NOI18N
        jLabel3.setText("Ingresa identificador");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(alphabet.validarCadenaER(textAlphabet.getText())){
            
            jLabel2.setForeground(new java.awt.Color(0, 153, 51));
            jLabel2.setText("Palabra válida");
        }else{
            jLabel2.setForeground(new java.awt.Color(255, 0, 0));
            jLabel2.setText("Palabra inválida");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(entradaREGEX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new entradaREGEX().setVisible(true);
            }
        });
    }
